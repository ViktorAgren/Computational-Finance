function [Value,Error] = FD_explicit(S0,Smin,Smax,K,r,sigma,T,gamma,M,N)
% Value of a European Call option and error between the analytical and the
% explicit finite difference method.
%
% [Value,Error] = FD_emplicit(S0,Smin,Smax,K,r,sigma,T,gamma,M,N)
%
% Inputs:
